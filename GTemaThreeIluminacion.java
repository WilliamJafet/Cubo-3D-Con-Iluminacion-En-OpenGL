 ...
 */
public class GTemaThreeIluminacion implements GLEventListener {
    static GL gl;
    static GLU glu;
    ...
    public static void main(String[] args) {
        Frame frame = new Frame("Cubo 3D iluminado");
        GLCanvas canvas = new GLCanvas();

        canvas.addGLEventListener(new GTemaThreeIluminacion());
        frame.add(canvas);
	...
	float[] luzPos = {3.0f, 3.0f, 0.0f, 1.0f};
        ...
        gl.glLightfv(GL.GL_LIGHT0, GL.GL_DIFFUSE, luzDif, 0);
        gl.glLightfv(GL.GL_LIGHT0, GL.GL_POSITION, luzPos, 0);
        gl.glShadeModel(GL.GL_SMOOTH);
        gl.glEnable(GL.GL_COLOR_MATERIAL);
        gl.glMaterialfv(GL.GL_FRONT_AND_BACK, GL.GL_DIFFUSE, luzDif,0);
    }
